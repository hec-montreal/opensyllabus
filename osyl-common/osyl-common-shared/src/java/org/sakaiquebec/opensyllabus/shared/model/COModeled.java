...
public class COModeled extends COSerialized implements COModelInterface {
	...
	coContentUnitType = coMap.getNamedItem(TYPE_ATTRIBUTE_NAME)
	.getNodeValue();
	...
	if (COContentUnitType.EVALUATION.equals(coContentUnitType)) {
	    /*coContentUnit.setWeight(coMap.getNamedItem(WEIGHT_ATTRIBUTE_NAME)
		    .getNodeValue());
	    coContentUnit.setLocation(coMap.getNamedItem(
	...
	coContentRes.setType(rMap.getNamedItem(TYPE_ATTRIBUTE_NAME)
		.getNodeValue());
	coContentRes.setSecurity(rMap.getNamedItem(SECURITY_ATTRIBUTE_NAME)
		.getNodeValue());
	// documentSecurityMap.add();
	...
	createRootElement(document, getModeledContent());
	...
	if (child.isCOStructureElement()) {
	    ...
	    coContentUnitElem.setAttribute(TYPE_ATTRIBUTE_NAME, coContentUnit
		    .getType());
	    // Evaluation attributes
//	    coContentUnitElem.setAttribute(WEIGHT_ATTRIBUTE_NAME, coContentUnit
//		    .getWeight());
