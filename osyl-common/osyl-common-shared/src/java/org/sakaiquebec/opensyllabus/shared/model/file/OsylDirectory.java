...
public class OsylDirectory extends OsylAbstractBrowserItem implements
	Serializable {
    ...
    public OsylDirectory(String newDirName, String newDirPath,
	    String newLastModif, List<OsylAbstractBrowserItem> list) {
	...
	if (obj instanceof OsylDirectory) {
