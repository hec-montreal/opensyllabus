...
/**
 * FiresUpdateCOContentResourceProxyEvents interface
 * 
 * @author <a href="mailto:claude.coulombe@umontreal.ca">Claude Coulombe</a>
 * @version $Id: $
 */
public interface FiresUpdateCOContentResourceProxyEvents {
     ...
     * @param handler
     */
    public void removeEventHandler(UpdateCOContentResourceProxyEventHandler handler);
}
