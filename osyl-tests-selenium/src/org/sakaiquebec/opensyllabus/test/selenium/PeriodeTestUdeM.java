 ...
 * the first page), enters in the Lectures section, add two periods,
 * name the last one, edit the last period, rename it, add text, add 
 * hyperlink, add document , add citation, switch the tow added periods, 
...
//---------------------------------------------------------------------------//
	...
	//Add Text in the last Period Unit
	clickAddItem("addText");

	//We edit the new text Period
...
//---------------------------------------------------------------------------//
	...
	session().select("//table/tbody/tr/td[2]/table/tbody/tr[2]/td/select","index=0");
        ...
        session().type("uploadFormElement", "C:\\Documents and Settings\\hernana\\Bureau\\testUdeM.txt");
	...
	//Close window
        ...
        // Choose file and close window
        session().type("//input[@class=\"gwt-FileUpload\"]", "C:\\Documents and Settings\\hernana\\Bureau\\testUdeM2.txt");
      //We select randomly the rights field
	String xpathRole4 = "//div[2]/form/table/tbody/tr[5]/td/select";
	String newText8 = getRandomOption(xpathRole4);
	session().select(xpathRole4, newText8);
