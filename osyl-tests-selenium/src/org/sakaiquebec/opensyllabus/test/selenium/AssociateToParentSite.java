...
public class AssociateToParentSite extends AbstractOSYLTest {
	...
	String parentText= "this is a text resource typed by "
	...
	session().selectFrame("relative=parent");
	goToOsylManagerTool();
	session().type("//input[@class='gwt-TextBox']", getCurrentTestSiteName());
	...
	pause();
	session().mouseOver("//div[@class='OsylManager-action OsylManager-action-up' and ./div[contains(.,'Lier')]]");
	session().mouseDown("//div[@class='OsylManager-action OsylManager-action-up-hovering' and ./div[contains(.,'Lier')]]");
	session().mouseUp("//div[@class='OsylManager-action OsylManager-action-down-hovering' and ./div[contains(.,'Lier')]]");
	pause();
	session().select("//select[@class='OsylManager-form-element']", "label="+parentSiteName);
	pause();
	session().mouseOver("//div[@class='Osyl-Button Osyl-Button-up' and ./div[contains(.,'Lier')]]");
	session().mouseDown("//div[@class='Osyl-Button Osyl-Button-up-hovering' and ./div[contains(.,'Lier')]]");
	session().mouseUp("//div[@class='Osyl-Button Osyl-Button-down-hovering' and ./div[contains(.,'Lier')]]");
	pause();
	assertTrue(session().isElementPresent("//div[contains(.,'bien')]"));
	session().mouseOver("//div[@class='Osyl-Button Osyl-Button-up' and ./div[contains(.,'Fermer')]]");
	session().mouseDown("//div[@class='Osyl-Button Osyl-Button-up-hovering' and ./div[contains(.,'Fermer')]]");
	session().mouseUp("//div[@class='Osyl-Button Osyl-Button-down-hovering' and ./div[contains(.,'Fermer')]]");
	...
	session().mouseUp("//div[@class='OsylManager-action OsylManager-action-down-hovering' and ./div[contains(.,'Lier')]]");
	pause();
	session().select("//select[@class='OsylManager-form-element']", "label="+getCurrentTestSiteName());
	pause();
	session().mouseOver("//div[@class='Osyl-Button Osyl-Button-up' and ./div[contains(.,'Lier')]]");
	session().mouseDown("//div[@class='Osyl-Button Osyl-Button-up-hovering' and ./div[contains(.,'Lier')]]");
	session().mouseUp("//div[@class='Osyl-Button Osyl-Button-down-hovering' and ./div[contains(.,'Lier')]]");
	...
	session().click("//tr[@class='OsylManager-scrollTable-row']/td/input");
	pause();
	session().mouseOver("//div[@class='OsylManager-action OsylManager-action-up' and ./div[contains(.,'tacher')]]");
	session().mouseDown("//div[@class='OsylManager-action OsylManager-action-up-hovering' and ./div[contains(.,'tacher')]]");
	session().mouseUp("//div[@class='OsylManager-action OsylManager-action-down-hovering' and ./div[contains(.,'tacher')]]");
	pause();
