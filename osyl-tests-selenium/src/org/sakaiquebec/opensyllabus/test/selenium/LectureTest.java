 ...
 * check the text is here, click save, log out.<br/><br/>
 *
...
public class LectureTest extends AbstractOSYLTest {
	...
	public void testDeleteAddLecture(String webSite) throws Exception {
		...
		int lectureNb = session()
			.getXpathCount("//div[@class=\"Osyl-LabelEditor-View\"]").intValue();
...
*/
		...
		session().click("//td[2]/button[@class=\"Osyl-Button "
		...
		// is the 1st lecture)
		session().click("//tr[" + lectureNb
			+ "]/td/table/tbody/tr/td[2]/div/table[2]/tbody/tr/td[1]/button");
		// Type a new name
