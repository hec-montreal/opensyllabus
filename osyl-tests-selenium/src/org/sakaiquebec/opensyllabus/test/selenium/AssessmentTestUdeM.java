...
public class AssessmentTestUdeM extends AbstractOSYLTest{
...
//---------------------------------------------------------------------------//
        ...
        session().mouseDown("//div[@class=\"gwt-TreeItem\"]/table/tbody/tr/td" +
        		"/div[contains(text(),'Évaluation des apprentissages')]");
		...
		// Open Assessment Unit
		session()
				.mouseDown(
						"//html/body/table/tbody/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/div/table/tbody/tr[2]/td/div/div[2]/div/div[5]/div/div[2]");
...
//---------------------------------------------------------------------------//
	...
	String newText10 = "http://www.umontreal.ca/";
	...
	if (inFireFox()) {
        	//Overview
        	session().click("gwt-uid-6");  ///gwt-uid-7
        	//Attendee Overview 
        	session().click("//html/body/div/div/table/tbody/tr[2]/td[2]/div/" +
        			"div/table/tbody/tr/td");
        	pause();
...
//---------------------------------------------------------------------------//
	...
	if (inFireFox()) {
        	...
        	session().type("uploadFormElement", "C:\\Documents and Settings\\hernana\\Bureau\\testUdeM2.txt");;
	...
	if (inFireFox()) {
	    	...
	    	// Choose file 
	    	session().type("//input[@class=\"gwt-FileUpload\"]", "C:\\Documents and Settings\\hernana\\Bureau\\testUdeM.txt");;
