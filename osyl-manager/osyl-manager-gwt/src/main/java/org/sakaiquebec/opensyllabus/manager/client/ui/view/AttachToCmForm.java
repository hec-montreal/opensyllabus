 ...
 * @version $Id: $
 */
public class AttachToCmForm extends OsylManagerAbstractWindowPanel {
	...
	public void onSuccess(Void result) {
	    ...
	    AttachToCmForm.this.onAssociationEnd();
	}

    };

    public AttachToCmForm(final OsylManagerController controller, COSite site,
	...
	okButton.addClickHandler(new ClickHandler() {
		...
		diag.show();
		diag.centerAndFocus();
		AttachToCmForm.this.controller.associateToCM(selectedCourse
