...
<xsl:variable name='plagiatCalculatriceLabel_version15Avril2008'>
	...
	<p>Toutes les formes d?évaluation peuvent faire l?objet d?une analyse par un logiciel de détection de similitudes</p>
		&lt;/div &gt;
		&lt;br&gt;
		&lt;div class="bulletCarreVert" &gt;
...
<xsl:variable name='actResBeforeLbl'>Activités/Ressources avant la séance</xsl:variable>

<xsl:variable name='actResDuringTag'>rubriqueActivitesRessourcesPendantSeance</xsl:variable>
<xsl:variable name='actResDuringLbl'>Activités/Ressources pendant la séance</xsl:variable>

<xsl:variable name='actResAfterTag'>rubriqueActivitesRessourcesApresSeance</xsl:variable>
<xsl:variable name='actResAfterLbl'>Activités/Ressources après la séance</xsl:variable>
...
<xsl:variable name='plagiatBAA'>Les étudiants sont priés de consulter l'&lt;b>&lt;a href="http://www.hec.ca/plagiat/reglement.html"> article 12 &lt;/a>&lt;/b> du &lt;i> Règlement régissant l'activité étudiante à HEC Montréal &lt;/i>intitulé Plagiat et fraude, de prendre connaissance des actes et des gestes qui sont considérés comme étant du plagiat ou une autre infraction de nature pédagogique (12.1), de la procédure (12.2) et des sanctions, qui peuvent aller jusqu'à la suspension et même l'expulsion de l'École (12.3).  Toute infraction sera analysée en fonction des faits et des circonstances, et une sanction sera appliquée en conséquence.<p>Toutes les formes d?évaluation peuvent faire l?objet d?une analyse par un logiciel de détection de similitudes</p></xsl:variable>
