 ...
 * @version $Id: $
 */
public abstract class OsylViewableDialogBox extends DialogBox implements
	OsylViewable {
     ...
     */
    protected OsylViewableDialogBox(OsylAbstractView view,
	    OsylController osylController, boolean autoHide, boolean modal) {
    ...
    /**
     * Sets the <{@link OsylAbstractView}.
     * 
     * @param view
     */
