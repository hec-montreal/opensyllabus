...
public class OsylTestCOMessagesUdeM {
	...
	if (messages == null) {
	    ...
	    messages.put("ResProxContactInfoView_LastNameMandatory",
		    "La coordonn�e nom de famille ne peut pas être vide");
	    ...
	    messages.put("coursespecialevents", "Événements spéciaux");
...
//	    messages.put("Evaluation.Scope.Obl","Obligatoire");
	    ...
	    messages.put("lectures", "Présentation des activités d’enseignement par séance");
	    messages.put("lecturesShort", "Liste des séances");

	    messages.put("LecturesListContextSkills", "Présentation des activités d’enseignement par rencontre");
	    ...
	    messages.put("ThemesList", "Présentation des activités d’enseignement par thème");
