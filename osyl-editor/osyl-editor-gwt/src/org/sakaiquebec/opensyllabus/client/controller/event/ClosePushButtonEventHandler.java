 ...
 * @version $Id: $
 */
public interface  ClosePushButtonEventHandler {
    	
    	/**
    	 * Event triggered when the save Button is pushed 
    	 * @version $Id: $
    	 */
	public class ClosePushButtonEvent extends EventObject {
		 ...
		 * @param source
		 */
		public ClosePushButtonEvent(Object source) {
			super(source);
		}
	}
	 ...
	 * @param event
	 */
	void onClosePushButton(ClosePushButtonEvent event);
}
