...
public class COTestContent {
	...
	RequestBuilder requestBuilder =
		new RequestBuilder(RequestBuilder.GET, COTestContent.PATH + filename);

	try {
	    requestBuilder.sendRequest(null, new RequestCallback() {
		public void onError(Request request, Throwable exception) {
		    Window.alert("Error while reading "+COTestContent.PATH + filename+" :"+exception.toString());
		}
	    ...
	    Window.alert("Error while reading "+COTestContent.PATH + filename+" :"+ex.toString());
	}
    }
