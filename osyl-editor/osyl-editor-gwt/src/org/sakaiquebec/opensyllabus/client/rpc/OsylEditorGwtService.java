...
package org.sakaiquebec.opensyllabus.client.rpc;
...
/**
 * OsylEditorGwtService defines the RPC (Remote Procedure Call) interface between the GWT client application and the Sakai server.
...
public interface OsylEditorGwtService extends RemoteService {
     ...
     * @uml.property  name="serializedCourseOutline"
     * @uml.associationEnd  
     */
     ...
     * @uml.property  name="currentUserRole"
     */
     ...
     * @uml.property  name="serializedConfig"
     * @uml.associationEnd  
     */
