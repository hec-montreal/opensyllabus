...
public interface OsylEditorGwtServiceAsync {
	 ...
	 *            POJO
	 * @param callback
	 *            the callback to return the CourseOutline ID
	 */
	 ...
	 * 
	 * @param callback
	 *            the callback to return true if the CO has been published at
	 *            least one time;
	 */
	 ...
	 * 
	 * @param callback
	 *            the callback to return String userRole
	 */
	 ...
	 * @param group
	 * @param callback
	 *            will return the result of the transformation
	 */
