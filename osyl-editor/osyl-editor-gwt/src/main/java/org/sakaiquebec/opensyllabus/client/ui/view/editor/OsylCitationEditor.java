...
public class OsylCitationEditor extends OsylAbstractBrowserEditor {
	...
	protected void initBrowser() {
		...
		useLibraryLinkCheckBox.setWidth("90px");
		editorOtherLink = new TextBox();
		editorOtherLink.setWidth("370px");
		...
		saveButton = new ImageAndTextButton(imgSaveButton, getView()
				.getUiMessage("DocumentEditor.save.name"));
								...
								new AsyncCallback<String>() {
									...
									public void onSuccess(String result) {
										...
										OsylUnobtrusiveAlert alert = new OsylUnobtrusiveAlert(
												getUiMessage("fileUpload.resSaved"));
