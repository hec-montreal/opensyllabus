...
public class OsylServiceImpl implements OsylService {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="org.sakaiproject.citation.api.Citation"
	 */
	...
	private void updateCitationType(Citation citation, 
			String type) {
	...
	public String getXslForGroup(String group, String webappdir) {
		...
		File coXslFile =
			new File(webappdir + File.separator
					...
					xslFileName + OsylSiteService.XSL_FILE_EXTENSION);
		...
		try {
			...
			log.error("Erro while reading file: " + xslFileName
