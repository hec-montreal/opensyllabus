...
/**
 * This job adds the role bibliServPret with the correct permissions to all the
 * sites of type course. All the sites will be checked to make sure the role
 * has at least the specified permissions.
 *
 * @author <a href="mailto:mame-awa.diop@hec.ca">Mame Awa Diop</a>
 * @version $Id: $
 */
public interface BibliServPretSynchronizationJob extends Job {
    ...
    public final static List FUNCTIONS_TO_ALLOW =
	    Arrays.asList(new String[] { "site.visit", "content.read" });

    public final static String BIBLISERVPRET_ROLE = "bibliServPret";
