...
public class GenericProfCoursMapFactory {
     ...
     * verification on fait appel a DetailSessionsMap.getLatestSession().
     * <br><br>
     *
     ...
     * prof. L'operation complementaire, c'est a dire enlever les profs
    ...
    public static ProfCoursMap getInstance(String dataDir)
	throws IOException {
