...
import org.sakaiquebec.opensyllabus.admin.cmjob.api.HeldeskSynchronizationJob;

public class HelpdeskSynchronisationJobImpl implements
	HeldeskSynchronizationJob {
    ...
    private static Log log =
	    LogFactory.getLog(HelpdeskSynchronisationJobImpl.class);
	...
	try {
	    Role role = realm.getRole(HELPDESK_ROLE);
	...
	try {
	    Role role = realm.addRole(HELPDESK_ROLE);
